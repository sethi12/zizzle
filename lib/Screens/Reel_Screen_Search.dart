...
import 'package:newapp/Controllers/Search_video.dart';
...
class SearchVideoScreen extends StatefulWidget {
  final uid;
  final videoid;
  SearchVideoScreen({Key? key,required this.uid,required this.videoid}) : super(key: key);
...
class _SearchVideoScreenState extends State<SearchVideoScreen> {
  ...
  void initialstate()async{
    videoController = Get.put(SearchVideoController(selectedvideoid:widget.videoid ,));
    if (videoController.selectedvideoid != widget.videoid) {
      videoController.updateData(newvideoid: widget.videoid,);
      print("true");
    }
