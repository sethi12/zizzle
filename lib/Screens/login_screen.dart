...
import 'package:newapp/responsive/responsive_screen_layout.dart';
...
//     // Instead of calling LoginScreen() here, just keep the current screen.
...
// }
    ...
    if (_usernamecontroller.text.isNotEmpty ||
      ...
      if (ress == "Logged in Successfully") {
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder:
            (context)=>ResponsiveLayout(MobileScreenLayout:
  ...
  Future<void>resetPassword(String email)async{
    try{
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>UpadtePassword(email:email)));
    }catch(e){
      print(e.toString());
    }
  }
