...
import 'package:newapp/Controllers/comment_controller.dart';
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: InkWell(
                        onTap: () => commentController.likecomment(comment.id, comment.username),
                        child: Icon(
                          Icons.favorite,
                          size: 25,
                          color: comment.likes.contains(comment.username) ? Colors.red : Colors.white,
                        ),
                      ),
                    );
                  },
