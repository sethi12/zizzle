...
class _MonetizationPolicyState extends State<MonetizationPolicy> {
  ...
  void monitizeaccount()async{
    if(existinguser.data()?['Monetization']=="Not Monitized"){
      await _firestore.collection("users").doc(username).update({'Monetization':"Monitized"});
      setState(() {
        done = true;
      });
      if(done == true){
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>ProfileScreen()));
        showSnackBar("Congratulations your Account has been Monetized and you got a Zizzle verified Badge", context);
      }
    }
  }
  @override
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: "we're offering a fantastic deal – 1 CAD for every 1000 views on your reels!", style: TextStyle(color: Colors.blue)),
