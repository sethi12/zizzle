...
import 'package:newapp/widgets/Collabedpost.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('CollabRequests').where('reelid', isNull: false)
            .snapshots(),
        builder: (context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
          ...
          List<DocumentSnapshot<Map<String, dynamic>>> collabedRequestPosts = snapshot.data!.docs
              .where((collabRequest) => collabRequest['collabusername'] == widget.username)
              .toList();
