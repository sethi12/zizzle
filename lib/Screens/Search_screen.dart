...
import 'package:newapp/Screens/Reel_Screen_Search.dart';
import 'package:newapp/Screens/Search_Screen_profile.dart';
...
import 'package:newapp/widgets/post_card.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> fetchData() async {
    ...
    QuerySnapshot<Map<String, dynamic>> reelsSnapshot =
    await FirebaseFirestore.instance.collection('reels').where('isGlobalOptionEnabled', isEqualTo: true).get();
                ...
                if (index < filteredPosts.length) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => SearchVideoScreen(uid: filteredReels[reelsIndex]['uid'], videoid: filteredReels[reelsIndex]['id']),
                        ),
                      );
                      print(filteredReels[reelsIndex]['uid']);
                      print(filteredReels[reelsIndex]['id']);
                    },
                    child:VideplayerSearch(videourl:filteredReels[reelsIndex]['videourl'], id:filteredReels[reelsIndex]['id'], thumnail:filteredReels[reelsIndex]['thumbnail'],
