...
import 'package:newapp/Controllers/upload_video_controller.dart';
...
class AddReelDetails extends StatefulWidget {
  ...
  const AddReelDetails({Key? key, required this.videofile, required this.videopath})
      : super(key: key);
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      child:Text(collabuser,style: TextStyle(color: Colors.white),),
                                    )
                                  ],
                                )),
                          ),
                                      ...
                                      child:  Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text("Select your Audience ",style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 18,
                                                fontStyle: FontStyle.italic),),
                                          ),
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text("Public" ,style: TextStyle(fontSize: 20),),
                                                    ),
                                            ...
                                            child: Container(
                                              child: Row(
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.symmetric(horizontal: 20),
                                                    child: Text("Private" ,style: TextStyle(fontSize: 20),),
                                                  ),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(public,style: TextStyle(fontSize: 19),),
                                    )
                                  ],
                                )),
                          ),
