...
import 'package:newapp/widgets/videoplayersearch.dart';
      ...
      child: Column(
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  ...
                  Icons.favorite,
                  size: 34,
                  color:widget.snap['likes'].contains(username)?Colors.red
        : Colors.white.withOpacity(0.3),
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){
                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CommentReelScreen(id: widget.snap['id'])));
                  },
                  child: Icon(
